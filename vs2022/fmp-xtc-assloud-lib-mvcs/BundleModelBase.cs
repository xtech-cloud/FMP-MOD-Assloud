...
namespace XTC.FMP.MOD.Assloud.LIB.MVCS
{
    ...
    /// Bundle数据层基类
    /// </summary>
    public class BundleModelBase : Model
    {
        /// <summary>
        /// 带uid参数的构造函数
        /// </summary>
        ...
        public BundleModelBase(string _uid, string _gid) : base(_uid)
        {
            gid_ = _gid;
        }
        ...
        {
            getController()?.UpdateProtoCreate(status_ as BundleModel.BundleStatus, _response, _context);
        }
        ...
        {
            getController()?.UpdateProtoUpdate(status_ as BundleModel.BundleStatus, _response, _context);
        }
        ...
        public virtual void UpdateProtoRetrieve(BundleRetrieveResponse _response, object? _context)
        {
            getController()?.UpdateProtoRetrieve(status_ as BundleModel.BundleStatus, _response, _context);
        }
        ...
        {
            getController()?.UpdateProtoDelete(status_ as BundleModel.BundleStatus, _response, _context);
        }
        ...
        public virtual void UpdateProtoList(BundleListResponse _response, object? _context)
        {
            getController()?.UpdateProtoList(status_ as BundleModel.BundleStatus, _response, _context);
        }
        ...
        public virtual void UpdateProtoSearch(BundleListResponse _response, object? _context)
        {
        ...
        public virtual void UpdateProtoTidy(UuidResponse _response, object? _context)
        {
            getController()?.UpdateProtoTidy(status_ as BundleModel.BundleStatus, _response, _context);
        }
        ...
        /// </summary>
        /// <returns>控制层</returns>
        protected BundleController? getController()
        {
            if(null == controller_)
                controller_ = findController(BundleController.NAME + "." + gid_) as BundleController;
            return controller_;
        }
        ...
        /// 直系控制层
        /// </summary>
        private BundleController? controller_;
    }
}
