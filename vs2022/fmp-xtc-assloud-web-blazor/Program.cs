...
using XTC.FMP.MOD.Assloud.App.Web;
...
public partial class Program
{
    public static async Task Main(string[] args)
    {
        ...
        permissioS[Permissions.BundleCreate] = "";
        permissioS[Permissions.BundleUpdate] = "";
        permissioS[Permissions.BundleRetrieve] = "";
        permissioS[Permissions.BundleDelete] = "";

        permissioS[Permissions.ContentCreate] = "";
        permissioS[Permissions.ContentUpdate] = "";
        permissioS[Permissions.ContentRetrieve] = "";
        permissioS[Permissions.ContentDelete] = "";
        ...
        framework.setUserData("XTC.FMP.MOD.Assloud.LIB.MVCS.Entry", entry);
